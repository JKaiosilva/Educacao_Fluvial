...
var createScene = function () {
   ...
   const modelo3d = BABYLON.SceneLoader.ImportMesh("", "modelo3d/", "loy_boat.obj", scene, function (newMeshes) {
    ...
    var rect1_colete_salva_vidas = new BABYLON.GUI.Rectangle();
        ...
        rect1_colete_salva_vidas.background = "MidnightBlue"; 
...
var rect1_GPS = new BABYLON.GUI.Rectangle();
    ...
    rect1_GPS.background = "MidnightBlue"; 
    rect1_GPS.alpha = 0.7;
    rect1_GPS.scaleX = 0;
    rect1_GPS.scaleY = 0;
...
var rect1_ancora = new BABYLON.GUI.Rectangle();
    ...
    rect1_ancora.background = "MidnightBlue"; 
